                ...
                <div class="tabs__content-window">
                    <div class="tabs__content-window-panel">
                        <div v-show="isActive('tab-1')" class="tabs__content-window-panel-fx">
                            ...
                            <div class="info">
                                <p>
                                    I'm currently learning <span>TypeScript</span>, a powerful JavaScript-based tool. So I am a starter in this
                                    ...
                                    <br />
                                    <br />
                                    My main tools for creating websites, web apps, and other projects are <span>Vue.js</span>, <span>Nuxt</span>,
                                    <span>Pinia</span>, and <span>Sass</span>.
                                    <br />
                                    <span>Vue.JS</span> helps me build interactive and dynamic user interfaces, while <span>Pinia</span> is my go-to
                                    state management solution for maintaining consistent and predictable application state. <span>Nuxt</span> enhances
                                    my development workflow by providing a robust framework for building server-side rendered applications, static
                                    websites, and more. <span>Sass</span> allows me to write more efficient and maintainable <span>CSS</span>, making
                                    my styling process smoother and more organized.
                                    <br />
                                    <br />
                                    By combining these tools with my growing knowledge of <span>TypeScript</span>, <span>Nuxt</span>, and
